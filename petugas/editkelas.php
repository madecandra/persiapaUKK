<?php
    ...
    if(isset($_POST['submit'])){
        if ( $kelas->edit($_POST) > 0 ) {
            header ("Location: ../petugas/daftar_kelas.php");
        }
    }
    $read = "SELECT * FROM kelas WHERE id_kelas = {$_GET['id_kelas']}";
                        ...
                        <form method="post" acttion="">
                            <?php foreach($reads as $key): ?>
                                ...
                                <div class="form-grup">
                                    ...
                                    <input type="text" name="nama_kelas" class="form-control" value="<?= $key['nama_kelas'] ?>">
                                </div>
                                <div class="form-grup">
                                    <label for="">Kompetensi Keahlian</label>
                                    <input type="text" name="kompetensi_keahlian" class="form-control" value="<?= $key['kompetensi_keahlian'] ?>">
                                </div>
                            <?php endforeach; ?>
