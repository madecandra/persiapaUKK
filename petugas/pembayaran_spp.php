                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-4">
                            <div class="card-header">
                                <a href="../petugas/tambahpembayaran.php" class="btn btn-dark my-2">Tambah Data SPP</a>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropdown no-arrow">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            ...
                                                            <a href="editpembayaran.php?id_spp=<?= $read['id_spp'] ?>" class="dropdown-item" id="adminEditSppBtn" >Edit</a>
                                                            <!-- <div class="dropdown-divider"></div> -->
                                                            <a href="hapuspembayaran.php?id_spp=<?= $read['id_spp'] ?>" class="dropdown-item text-danger">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><?=$read['tahun']?></td>
