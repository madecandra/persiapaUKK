<?php 
    ...
    $read = "SELECT * FROM spp WHERE id_spp = {$_GET['id_spp']}";
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <form method="post" acttion="">
                            <?php foreach($reads as $key): ?>
                                <input type="hidden" name="id_spp" value="<?= $key['id_spp'] ?>">
                            <div class="form-grup">
                                <label for="">Tahun Bayar</label>
                                <input type="text" name="tahun" class="form-control" value="<?= $key['tahun'] ?>">
                            </div>
                            <div class="form-grup">
                                <label for="">Nominal</label>
                                <input type="text" name="nominal" class="form-control" value="<?= $key['nominal'] ?>">
                            </div>
                            <?php endforeach; ?>
