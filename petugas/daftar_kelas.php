    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SPP-BRO <sup>petugas</sup></div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="../beranda/petugas.php">
                    <i class=""></i>
                    <span>Beranda</span>
                </a>
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../petugas/daftar_kelas.php">
                    <i class=""></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../petugas/pembayaran_spp.php">
                    <i class=""></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../petugas/riwayat_pembayaran.php">
                    <i class=""></i>
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="card shadow border-0 mb-4">
                            <div class="card-header">
                                <a href="../petugas/tambahkelas.php" class="btn btn-dark my-2">Tambah Data SPP</a>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropdown no-arrow">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            ...
                                                            <a href="editkelas.php?id_kelas=<?= $read['id_kelas'] ?>" class="dropdown-item" id="adminEditSppBtn" >Edit</a>
                                                            <!-- <div class="dropdown-divider"></div> -->
                                                            <a href="hapuskelas.php?id_kelas=<?= $read['id_kelas'] ?>" class="dropdown-item text-danger">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><?=$read['nama_kelas']?></td>
                                                <td><?=$read['kompetensi_keahlian']?></td>
                                            </tr>
                                        <?php } ?> 
                                    </tbody>
                                </table>
