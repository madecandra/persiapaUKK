                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-4">
                            <div class="card-header">
                                <a href="../pengguna/tambahpetugas.php" class="btn btn-dark my-2">Tambah Data Petugas</a>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
                                                    <div class="dropdown no-arrow">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                            ...
                                                            <a href="editpetugas.php?id_petugas=<?= $read['id_petugas'] ?>" class="dropdown-item" id="adminEditSppBtn" >Edit</a>
                                                            <!-- <div class="dropdown-divider"></div> -->
                                                            <a href="hapuspetugas.php?id_petugas=<?= $read['id_petugas'] ?>" class="dropdown-item text-danger">Hapus</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><?=$read['username']?></td>
                                                <td><?=$read['password']?></td>
                                                <td><?=$read['nama_petugas']?></td>
                                                <td><?=$read['id_level']?></td>     
                                            </tr>
                                        <?php } ?> 
                                    </tbody>
