...
$read = "SELECT * FROM siswa WHERE id_siswa = {$_GET['id_siswa']}";
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <?php foreach($reads as $key): ?>
                            ...
                            <div class="form-grup">
                                ...
                                <input type="text" name="nisn" class="form-control"  value="<?= $key['nisn'] ?>">
                            </div>
                            <div class="form-grup">
                                <label for="">Nis</label>
                                <input type="text" name="nis" class="form-control"  value="<?= $key['nis'] ?>">
                            </div>
                            <div class="form-grup">
                                <label for="">Nama Siswa</label>
                                <input type="text" name="nama_siswa" class="form-control"  value="<?= $key['nama_siswa'] ?>">
                            </div>
                            <div class="form-grup">
                            ...
                            <div class="form-grup">
                                ...
                                <input type="text" name="no_telp" class="form-control"  value="<?= $key['no_telp'] ?>">
                            </div>
                            <div class="form-grup">
                            ...
                            <div class="form-grup">
                                ...
                                <input type="text" name="id_kelas" class="form-control"  value="<?= $key['id_kelas'] ?>">
                            </div>
                            <div class="form-grup">
                                <label for="">ID Spp</label>
                                <input type="text" name="id_spp" class="form-control"  value="<?= $key['id_spp'] ?>">
                            </div>
